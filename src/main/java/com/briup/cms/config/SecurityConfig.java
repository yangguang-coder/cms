...
import com.briup.cms.web.controller.Filter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Bean
    public Filter getauthenticationTokenFilterBean() {
        return new Filter();
    }
    ...
    @Bean
    public LoginFalseHandler getLoginFailHandler() {
        return new LoginFalseHandler();
    }
